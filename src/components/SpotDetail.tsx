...
const SpotDetail: React.FC<SpotDetailProps> = ({spot, onClose}) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div
                className="relative w-full max-w-4xl max-h-[90vh] bg-white rounded-xl shadow-xl overflow-hidden scale-in">
                <button
                    onClick={onClose}
                        ...
                        <div className="mb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <div className="p-4 bg-gray-50 rounded-lg flex flex-col items-center">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            {spot.noise === 1 ? 'Very Quiet' :
                                                spot.noise === 2 ? 'Quiet' :
                                                    spot.noise === 3 ? 'Moderate' :
                                                        spot.noise === 4 ? 'Noisy' :
                                                            'Very Noisy'}
                                        </p>
                                    </div>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg flex flex-col items-center">
                                    ...
                                    <div className="text-center">
                                        <h4 className="text-sm font-medium text-gray-900 mb-1">WiFi Strength</h4>
                                        <RatingStars rating={spot.wifi} max={5}/>
                                        <p className="text-xs text-gray-500 mt-1">
                                            {spot.wifi === 1 ? 'Poor' :
                                                spot.wifi === 2 ? 'Fair' :
                                                    spot.wifi === 3 ? 'Good' :
                                                        spot.wifi === 4 ? 'Very Good' :
                                                            'Excellent'}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg flex flex-col items-center">
                                    ...
                                    <div className="text-center">
                                        <h4 className="text-sm font-medium text-gray-900 mb-1">Seating</h4>
                                        <RatingStars rating={spot.seating} max={5}/>
                                        <p className="text-xs text-gray-500 mt-1">
                                            {spot.seating === 1 ? 'Very Limited' :
                                                spot.seating === 2 ? 'Limited' :
                                                    spot.seating === 3 ? 'Moderate' :
                                                        spot.seating === 4 ? 'Abundant' :
                                                            'Very Abundant'}
                                        </p>
                                    </div>
                                </div>
                            ...
                            {/* Hours & Peak Times */}
                            <div className="mb-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-3">Hours & Peak Times</h3>
                                <div className="flex flex-col md:flex-row gap-4">
                                    <div className="flex-1 p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <p className="text-gray-700">
                                            {spot.hours.open === '0:00' && spot.hours.close === '24:00'
                                                ? 'Open 24/7'
                                                : `${spot.hours.open} - ${spot.hours.close}`}
                                        </p>
                                    </div>
                                ...
                                {reviews.length === 0 ? (
                                    ...
                                    <div className="space-y-4">
                                        {showReviews
                                            ...
                                            : reviews.slice(0, 2).map(review => <ReviewCard key={review.id}
                                                                                            review={review}/>)
                                        }
                                    </div>
                                )}
