  ...
  return (
    <header 
      className={cn(
        ...
        scrolled ? "bg-white/90 backdrop-blur-md shado  w-soft" : "bg-transparent"
      )}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <MapPin className="h-6 w-6 text-primary mr-2" />
          <h1 className="text-xl font-semibold text-gray-900 tracking-tight">UBSeats</h1>
        </div>
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <a href="#spots" className="text-gray-700 hover:text-primary transition-colors font-bold">Spots</a>
          <a href="#map" className="text-gray-700 hover:text-primary transition-colors font-bold">Map</a>
          <a href="#reviews" className="text-gray-700 hover:text-primary transition-colors font-bold">Reviews</a>
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-white shadow-lg rounded-b-lg p-4 slide-up">
          <nav className="flex flex-col space-y-4">
            ...
            <a href="#spots" onClick={toggleMenu} className="text-gray-700 hover:text-primary transition-colors font-bold px-2 py-1">Spots</a>
            <a href="#map" onClick={toggleMenu} className="text-gray-700 hover:text-primary transition-colors font-bold px-2 py-1">Map</a>
            <a href="#reviews" onClick={toggleMenu} className="text-gray-700 hover:text-primary transition-colors font-bold px-2 py-1">Reviews</a>
