...
const Header = ({
  ...
  return (
    <>
      <header
        className={cn(
          'fixed left-[5vw] top-5 z-10 h-16.5 w-[90vw] rounded-full bg-white px-4 py-2 shadow-soft backdrop-blur-md transition-all duration-300 md:px-8 md:py-3',
          customWrapperCss,
        )}
      >
              ...
              {!isMobile && (
                <form className="relative" onSubmit={handleSearchSubmit}>
                  <input
                    ...
                    className="w-[40vw] rounded-full border border-transparent bg-gray-100 py-2 pl-10 pr-4 outline-hidden transition-all focus:border-gray-300 focus:bg-white focus:ring-2 focus:ring-blue-100"
                  />
