  ...
  useEffect(() => {
    ...
    spots.forEach(spot => {
      ...
      markerDiv.className = cn(
        ...
        isSelected ? "bg-primary text-white scale-125" : "bg-white text-primary border border-primary hover:scale-110"
      );
      ...
      if (isSelected) {
        ...
        nameDiv.className = 'mt-1 px-2 py-1 text-xs font-medium bg-white rounded-md shadow-md whitespace-nowrap';
